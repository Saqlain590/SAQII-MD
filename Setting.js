...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'SAQII MD',  // add the botname you want
  ownername:  process.env.OWNER_NAME || `SAQLAIN KING`, // add your name
  author:  process.env.PACK_AUTHER || 'SAQII MD BOT', 
  ...
  packname:  process.env.PACK_NAME || "SAQII MD" , 
  ...
  LANG: process.env.THEME|| 'SAQII-MD',
