...
`;
  ...
  return await saqi.sendMessage(person.chat, buttonMessaged, {
      quoted: person,
  });
...
SIGMA_THEMES+=`┃✗SAQII-MD\n┃✗ ${prefix}setvar THEME:SAQII-MD\n┗━━━━━━━━━━⦿`
return man.reply(SAQII-MD_THEMES)
...
const sigma_male_salain = require('performance-now')
   timestampe = sigma_male_saqlain();
       latensie = sigma_male_saqlain() - timestampe;
